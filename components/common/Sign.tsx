...
export default function Sign({children, href}: {children?: React.ReactNode, href?: string}){
    ...
    return (
	    ...
	    <Link href = {href ? href : ""}>
		    <div onClick={() => clickPlay()} className = "md:max-lg:justify-around group border-amber-950 border-2 h-max break-all flex justify-between items-center uppercase text-center bg-amber-800 brightness/75  inset-shadow-accent/50 font-text *:text-red-950 text-md md:text-lg lg:text-2xl p-4 vignette-sm">
